...
const KCAL_PER_GRAM = 9;

@Injectable()
export class MacroFatGramsFromPercentV1Strategy implements CalculationStrategy {
  readonly meta: CalculationStrategyMeta = {
    id: 'MACRO_FAT_GRAMS_FROM_PERCENT_V1',
    metricId: 'FAT_G',
    version: 'v1.0.0',
    population: ['ADULT'],
    phase: ['PLAN'],
    requiredInputs: [
      ...
      { key: 'percent', label: 'Porcentaje de lípidos (%)', required: true },
    ],
    outputUnit: 'g',
    label: 'Porcentaje del GET',
    reference: { citation: 'Factor de Atwater: 9 kcal/g de lípido.' },
  };
