...
@Injectable()
export class MacroCarbsGramsFromPercentV1Strategy implements CalculationStrategy {
  readonly meta: CalculationStrategyMeta = {
    id: 'MACRO_CARBS_GRAMS_FROM_PERCENT_V1',
    metricId: 'CARBS_G',
    version: 'v1.0.0',
    population: ['ADULT'],
    phase: ['PLAN'],
    requiredInputs: [
      ...
      { key: 'percent', label: 'Porcentaje de carbohidratos (%)', required: true },
    ],
    outputUnit: 'g',
    label: 'Porcentaje del GET',
    reference: { citation: 'Factor de Atwater: 4 kcal/g de carbohidrato.' },
  };
